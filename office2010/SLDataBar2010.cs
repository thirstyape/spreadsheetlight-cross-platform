...
internal class SLDataBar2010
{
    ...
    {
        return new SLDataBar2010
        {
            Cfvo1 = this.Cfvo1.Clone(),
            Cfvo2 = this.Cfvo2.Clone(),
            FillColor = this.FillColor.Clone(),
            BorderColor = this.BorderColor.Clone(),
            NegativeFillColor = this.NegativeFillColor.Clone(),
            NegativeBorderColor = this.NegativeBorderColor.Clone(),
            AxisColor = this.AxisColor.Clone(),
            ...
            NegativeBarColorSameAsPositive = this.NegativeBarColorSameAsPositive,
